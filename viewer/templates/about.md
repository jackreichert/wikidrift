...
| **L5: Compare framing across languages** | Checks whether other-language editions frame the same subject differently. When L1 finds a candidate rewrite window, the lightweight check compares matched before-and-after revisions in each edition and links to every version used. Without a candidate window, it compares current leads. | [Omnipedia (Bao et al., 2012)](https://doi.org/10.1145/2207676.2208553) and [Manypedia (Massa & Scrinzi, 2012)](https://doi.org/10.1145/2462932.2462960) |
